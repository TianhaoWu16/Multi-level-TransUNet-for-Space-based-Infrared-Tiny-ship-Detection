...
def save_model_and_result(dt_string, epoch,train_loss, test_loss, best_iou, recall, False_alarm,nIoU, save_mIoU_dir, save_other_metric_dir):
...
def save_model(mean_IOU, best_iou, save_dir, save_prefix, train_loss, test_loss, recall,False_alarm,Final_nIoU, epoch, net):
        ...
        save_model_and_result(dt_string, epoch, train_loss, test_loss, mean_IOU,
                              recall, False_alarm,Final_nIoU , save_mIoU_dir, save_other_metric_dir)
...
def save_loss_Input(map, source_image_path,target_image_path, val_img_ids, suffix):
    ...
    predsss = Image.fromarray(predsss.reshape(1024, 1024))
    pred_img = predsss
