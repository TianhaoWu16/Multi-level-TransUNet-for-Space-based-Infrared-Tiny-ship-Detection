...
def parse_args():
    ...
    # choose model
    parser.add_argument('--model', type=str, default='MTU_Net',
                        help='model name: MTU_Net')
    ...
    parser.add_argument('--dataset', type=str, default='NUDT-SIRST-Sea',
                        help='dataset name:  NUDT-SIRST,NUDT-SIRST-Sea')

    parser.add_argument('--mode', type=str, default='TXT', help='mode name:  TXT, Ratio')
    parser.add_argument('--test_size', type=float, default='0.5', help='when mode==Ratio')
    parser.add_argument('--root', type=str, default='dataset/')
    parser.add_argument('--suffix', type=str, default='.png')
    parser.add_argument('--split_method', type=str, default='idx_4961+847',
                        help='50_50, idx_4961+847,10000_100(for NUST-SIRST),idx_512')
